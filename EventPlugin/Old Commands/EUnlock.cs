...
namespace ATTG3
{
    class EUnlock : ICommandHandler
    {
        private readonly ATTG3Plugin plugin;
        Server Server => PluginManager.Manager.Server;
        IConfigFile Config => ConfigManager.Manager.Config;
        public EUnlock(ATTG3Plugin plugin) => this.plugin=plugin;
        ...
        public string[] OnCall(ICommandSender sender, string[] args)
        {
            ...
            else
            {
                ...
                if (args.Length>0)
                {
                    ...
                    {
                        plugin.EULockdownact=!plugin.ULockdownact;
                ...
                {
                    return new string[] { "AGEULOCK: "+GetUsage() };
                }
            }
        }
    }
