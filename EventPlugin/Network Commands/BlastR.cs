...
namespace ATTG3
{
    class BlastR : ICommandHandler
    {
        private readonly ATTG3Plugin plugin;
        private bool running;
        public BlastR(ATTG3Plugin plugin)
        {
            this.plugin = plugin;
        }
        ...
        public static readonly string[] CA = new string[] { "BlastR", "AGBLASTR" };
        public string[] OnCall(ICommandSender sender, string[] args)
        {
            ...
            return new[] { "BlastDoor Teleported" };
        }
    }
}
